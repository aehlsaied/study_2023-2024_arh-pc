...
Ввожу в созданный файл текст программы, у которой находит сумму значений функции (14 Вариант) f(x)=7*(x+1) для всех аргументов x, введенные пользовтелем. (рис. [-@fig:017]).
...
Создаю исполняемый файл и запускаю его, при x = 3, 4, 5, 3, 2 (рис. [-@fig:018]).
